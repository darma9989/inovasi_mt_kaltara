            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid text-center">
                    ...
                    <div class="box-header">
                        <h3 class='box-title' style="vertical-align:middle;">REPORT MAINTENANCE STO BERDASARKAN TANGGAL</h3>
                    </div>
        <div class="box-body">
        ...
        <table class="table table-bordered table-striped" id="mytable">
            <thead>
                ...
                <tr>
                    ...
                    <th style="padding-top: 3px; padding-bottom: 3px;vertical-align:middle;" class='text-center bg-gray'>PROVISIONING</th>
