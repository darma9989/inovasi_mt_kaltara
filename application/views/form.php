                ...
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            <tr><td>Datalist</td><td><?php echo datalist_dinamis('test', 'tbl_user', 'full_name','email') ?></td></tr>
                            <tr><td>Combobox</td><td><?php echo cmb_dinamis('test', 'tbl_user', 'full_name','email', 'id_users') ?></td></tr>
                        </table>
