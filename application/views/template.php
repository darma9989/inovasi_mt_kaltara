...
<html>
    <head>
        ...
        <title>SIMATA | SYSTEM INFORMASI MAINTENANCE</title>
		...
		<link rel="stylesheet" href="<?php echo base_url() ?>assets/adminlte/dist/css/bootstrap-datetimepicker.min.css">
        <!-- Theme style -->
    ...
    <body class="hold-transition skin-red sidebar-collapse layout-top-nav">
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo base_url() ?>index.php/welcome" class="logo">
                    ...
                    <span class="logo-mini"><b>SIMA</b></span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>SIMA</b>TA</span>
                </a>
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2018-2019 <a href="https://adminlte.io">SIMATA</a>.</strong> All rights
                reserved.
            </footer>
